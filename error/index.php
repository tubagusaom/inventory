...
<html lang="en" dir="ltr">
  <head>
    ...
    <meta name="description" content="ERORE">
    <meta name="author" content="https://www.instagram.com/tera.bytee/">

    <link rel="shortcut icon" href="<?= $base_home.'berkas/images/error.png'?>" type="image/x-icon" />
  ...
  <body>
    ...
    <div class="container">
        ...
        <p>
					<font class="font1">
            <!-- Server Error, silahkan <a href="<?=$base_home?>">refresh halaman</a> untuk coba kembali -->
            Server error , To try again <a href="<?=$base_home?>">Click Here</a>
					</font>
				</p>
        <p>
