...
//   echo $base_url;
	...
	// echo '<b>&nbsp; SELF </b>= '.			SELF;
	// echo "<br><br>";
	// echo '<b>&nbsp; FCPATH </b>= '.			FCPATH;
	// echo "<br><br>";
	// echo '<b>&nbsp; base_ </b>= '.				$base_;
	// echo "<br><br>";
	// echo '<b>&nbsp; uriSegments </b>= '.	$uriSegments[1];
?>
...
<html lang="en" dir="ltr">
  <head>
    ...
    <link rel="shortcut icon" href="<?= $base_url.'berkas/images/error-404.png'?>" type="image/x-icon" />
