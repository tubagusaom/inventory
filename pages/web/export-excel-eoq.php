...
include("../../_db.php");
	...
	$result=mysql_query("SELECT data_perencanaan.kode_obat as kode_obat, data_obat.nama_obat as nama_obat, data_obat.jenis_obat as jenis_obat, data_perencanaan.tgl as Tanggal, data_perencanaan.rata as Konsumsi_Rata2, data_perencanaan.periode as Periode_Pemesanan, data_perencanaan.lead as Lead_Time, data_perencanaan.safety as Safety_Stock, data_perencanaan.tersedia as Stok_Tersedia, data_perencanaan.eoq as EOQ
FROM data_perencanaan LEFT JOIN data_obat ON data_perencanaan.kode_obat = data_obat.kode_obat
