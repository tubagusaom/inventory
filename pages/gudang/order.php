...
<tr >
    ...
    <td>
			<a href="?cat=gudang&page=orderedit&id=<?php echo sha1($result['kode_obat']); ?>" class="a-aom">Lihat</a> -
			<a href="?cat=gudang&page=order&del=1&id=<?php echo sha1($result['kode_obat']); ?>" class="a-aom" onclick="return confirm('apakah anda yakin hapus?')">Hapus</a>
		</td>
  </tr>
<?php } ?>
