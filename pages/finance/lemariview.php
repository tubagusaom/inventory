...
<?php
	...
	$reload="?cat=finance&page=jenis";
	//Cari berapa banyak jumlah data*/

	$count_query   = mysql_query("SELECT COUNT(lemari_uang.kode_lemari) AS numrows,lemari_uang.kode_lemari, lemari_uang.nama_lemari FROM lemari_uang");
	...
	$query = mysql_query("SELECT lemari_uang.kode_lemari, lemari_uang.nama_lemari FROM lemari_uang GROUP BY lemari_uang.kode_lemari LIMIT $offset,$per_hal");
...
<tr>
    ...
    <td style="text-align:center; font-weight:bold">
			<a href="?cat=finance&page=lemariedit&id=<?php echo sha1($result['kode_lemari']); ?>" class="a-aom">Edit</a> -
