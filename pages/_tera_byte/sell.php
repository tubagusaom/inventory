...
<h2 style="padding-bottom:10px">Input Obat Keluar</h2>
  ...
  <div class="table-responsive">
    <table class=" table-aom">
      ...
      <tr>
        ...
        <td><input type="text" name="kodeobat" class="full-width" id="kodeobat" placeholder="Pilih Obat.."  onClick="window.open('<?php echo $baseurl; ?>pages/web/viewbarang.php','popuppage','width=700,toolbar=0,resizable=0,scrollbars=no,height=400,top=100,left=100');" required></td>
      </tr>
      <tr>
...
if(isset($_POST['button']))
{
	...
	if($rc==1)
	{
		if($_POST['qty'] < $rw['stok_tersedia'])
		{
		  ...
		  echo "<b><h2 style='color:red; text-align:center; padding-top:20px'>Stok Obat kurang</h2></b>";
		}
	}else{
		echo "<b><h2 style='color:red; text-align:center; padding-top:20px'>Stok Obat kosong !..</h2></b>";
	}
}
?>
